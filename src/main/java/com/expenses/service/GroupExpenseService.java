...
public interface GroupExpenseService {
    ...
    GroupExpense createNewExpense(String ownerEmailId, Double amount, int groupId, String Description) throws UserDoesNotExistException, GroupNotFoundException;

    GroupExpense createNewExpense(String ownerEmailId, Double amount, int groupId, String Description, Date date) throws UserDoesNotExistException, GroupNotFoundException;
